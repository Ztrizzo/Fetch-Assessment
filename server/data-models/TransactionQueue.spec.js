...
describe('insert', () => {
  ...
  const exampleTransaction2 = new Transaction({payer: 'Dole', points: 1090, timestamp: '2021-11-02T14:00:00Z'});
  const exampleTransaction4 = new Transaction({payer: 'Yoplait', points: 500, timestamp: '2023-11-02T14:00:00Z'});
  new Transaction({payer: 'Lays', points: 300, timestamp: '2022-08-02T14:00:00Z'})
